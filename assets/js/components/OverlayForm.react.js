                        ...
                        <div className="centered-box">
                            ...
                            <form OnSubmit={this._onCreateSubmit}>
                                <fieldset className="check-data">
                                    ...
                                    <input type="text" id="name" name="name" placeholder="e.g. HTTP @ Google.fr" value={this.state.selectedCheck.name} onChange={this.handleChnage} />
                                    ...
                                    <input type="number" id="port" name="port" placeholder="e.g. 80" value={this.state.selectedCheck.port} onChange={this.handleChange}/>
                                </fieldset>
